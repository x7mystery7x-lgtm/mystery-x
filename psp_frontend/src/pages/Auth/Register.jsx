...
const Register = () => {
  ...
  const role = location.pathname.includes('/admin') ? 'admin' : 'client';
      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p>Create your account to access secure payment solutions</p>
          </div>
        ...
        <div className="auth-sidebar">
          <div className="sidebar-content">
            <h3>Why Choose Mystery-X PSP?</h3>
            <p>Join thousands of businesses that trust us with their payment processing needs.</p>
